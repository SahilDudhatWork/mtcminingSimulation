                ...
                return (
                    ...
                    >
                        <Pressable
                            onPress={onPress}
                            style={{
                                backgroundColor: label == "MiningScreen" ? Colors.primaryColor : 'transparent',
                            ...
                            <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1, padding: verticalScale(15) }}>
                                <Image
                                    style={
                                        label === "MiningScreen" ?
                                            { height: verticalScale(40), width: verticalScale(40), tintColor: Colors.white }
                                            :
                                            { height: verticalScale(25), width: verticalScale(25), tintColor: isFocused ? Colors.primaryColor : 'grey' }
                                    }
                                    source={
                                        label === 'Rewards' ?
                                            isFocused ?
                                ...
                                />
                                {label !== "MiningScreen" ?
                                    <Text style={{ color: isFocused ? Colors.primaryColor : 'grey', fontSize: verticalScale(10) }}>{label}</Text> : null}
                            </View>
                        </Pressable>
                    </View>
                );
